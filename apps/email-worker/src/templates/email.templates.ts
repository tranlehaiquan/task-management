...
The Task Management Team`,
   ...
   * @param template - The email template type to render
   * @param data - The template data containing variables for the email
   * @returns The rendered email template with subject, text, and html
   */
